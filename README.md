...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/askbot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15128&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/askbot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `askbot` can be installed with:

```
conda install askbot
```

It is possible to list all of the versions of `askbot` available on your platform with:
